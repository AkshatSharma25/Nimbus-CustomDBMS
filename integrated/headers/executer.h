...
public:
    ...
    void showDatabases(map<string, database> &dbs);
    void showTables(map<string, database> &dbs, string &selectedDatabase);
    void executeFindDeleteUpdate(string &one,string &two,string &findInputs,map<string, database> &dbs, string &selectedDatabase);
};
